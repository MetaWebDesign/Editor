 ...
 * @generated
 */
public class MetaWebDesignDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MetaWebDesignDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Metawebdesign.metawebdesign.diagram.navigator.MetaWebDesignDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Metawebdesign.metawebdesign.diagram.navigator.MetaWebDesignDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Metawebdesign.metawebdesign.diagram.navigator.MetaWebDesignDomainNavigatorItem(
