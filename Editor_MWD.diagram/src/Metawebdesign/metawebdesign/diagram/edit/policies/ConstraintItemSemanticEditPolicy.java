...
public class ConstraintItemSemanticEditPolicy
	...
	public ConstraintItemSemanticEditPolicy() {
		super(
				Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Constraint_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Metawebdesign.metawebdesign.diagram.part.MetaWebDesignVisualIDRegistry
					.getVisualID(incomingLink) == Metawebdesign.metawebdesign.diagram.edit.parts.RelationContraintEditPart.VISUAL_ID) {
