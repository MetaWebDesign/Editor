...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Metawebdesign.metawebdesign.diagram.edit.policies.Group2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.GroupName2EditPart) {
			((Metawebdesign.metawebdesign.diagram.edit.parts.GroupName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureGroupNameFigure());
			return true;
		}
		return false;
	}
