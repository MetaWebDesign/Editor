...
public class Constraint2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Metawebdesign.metawebdesign.diagram.edit.policies.Constraint2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.ConstraintName2EditPart) {
			((Metawebdesign.metawebdesign.diagram.edit.parts.ConstraintName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConstraintOperatorFigure());
			return true;
		}
		return false;
	}
	...
	public class ConstraintFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureConstraintOperatorFigure;
		/**
		 * @generated
		 */
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureConstraintMansajeErrorFigure;
		...
		private void createContents() {
			...
			fFigureConstraintOperatorFigure.setText("<...>");
			...
			fFigureConstraintMansajeErrorFigure = new WrappingLabel();

			fFigureConstraintMansajeErrorFigure.setText("<...>");

			this.add(fFigureConstraintMansajeErrorFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureConstraintServiceFigure() {
			return fFigureConstraintServiceFigure;
		}
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureConstraintMansajeErrorFigure() {
			return fFigureConstraintMansajeErrorFigure;
		}
