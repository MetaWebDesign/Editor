...
public class FormEditPart extends ShapeNodeEditPart {
	...
	public class FormFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureCajonForm;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCajonForm = new RectangleFigure();

			this.add(fFigureCajonForm, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureCajonForm() {
			return fFigureCajonForm;
		}
