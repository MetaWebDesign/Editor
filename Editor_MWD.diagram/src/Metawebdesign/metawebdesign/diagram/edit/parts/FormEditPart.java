...
public class FormEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonViewComponentsForm();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonViewComponentsForm();
			pane.remove(((Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart) {
			return getPrimaryShape().getFigureCajonViewComponentsForm();
		}
	...
	public class FormFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureCajonViewComponentsForm;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCajonViewComponentsForm = new RectangleFigure();

			this.add(fFigureCajonViewComponentsForm, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureCajonViewComponentsForm() {
			return fFigureCajonViewComponentsForm;
		}
