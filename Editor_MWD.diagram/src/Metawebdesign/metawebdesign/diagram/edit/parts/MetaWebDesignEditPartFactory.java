	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart.VISUAL_ID:
				return new Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart(
						view);

			case Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenuEditPart.VISUAL_ID:
				return new Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenuEditPart(
						view);

			case Metawebdesign.metawebdesign.diagram.edit.parts.ClassAtributoEnCajonClassEditPart.VISUAL_ID:
				return new Metawebdesign.metawebdesign.diagram.edit.parts.ClassAtributoEnCajonClassEditPart(
						view);

			case Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart.VISUAL_ID:
				return new Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart(
						view);

			case Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenu2EditPart.VISUAL_ID:
				return new Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenu2EditPart(
						view);
