...
public class PageEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonViewComponentsPage();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonViewComponentsPage();
			pane.remove(((Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart) {
			return getPrimaryShape().getFigureCajonViewComponentsPage();
		}
	...
	public class PageFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureCajonViewComponentsPage;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCajonViewComponentsPage = new RectangleFigure();

			this.add(fFigureCajonViewComponentsPage, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureCajonViewComponentsPage() {
			return fFigureCajonViewComponentsPage;
		}
