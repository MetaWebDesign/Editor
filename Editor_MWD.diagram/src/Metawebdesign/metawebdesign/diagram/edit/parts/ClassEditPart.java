...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.ClassCompartmentCajonClassEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonClass();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Metawebdesign.metawebdesign.diagram.edit.parts.ClassCompartmentCajonClassEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.ClassCompartmentCajonClassEditPart) {
			IFigure pane = getPrimaryShape().getFigureCajonClass();
			pane.remove(((Metawebdesign.metawebdesign.diagram.edit.parts.ClassCompartmentCajonClassEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.ClassCompartmentCajonClassEditPart) {
			return getPrimaryShape().getFigureCajonClass();
		}
	...
	public class ClassFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureCajonClass;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureCajonClass = new RectangleFigure();

			this.add(fFigureCajonClass, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureCajonClass() {
			return fFigureCajonClass;
		}
