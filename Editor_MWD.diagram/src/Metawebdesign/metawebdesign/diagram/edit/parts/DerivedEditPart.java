...
public class DerivedEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Metawebdesign.metawebdesign.diagram.edit.policies.DerivedItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Metawebdesign.metawebdesign.diagram.edit.parts.DerivedNameEditPart) {
			((Metawebdesign.metawebdesign.diagram.edit.parts.DerivedNameEditPart) childEditPart)
