...
public class MetaWebDesignPaletteFactory {
	...
	private ToolEntry createDerived3CreationTool() {
		...
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Derived_2007);
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
	...
	private ToolEntry createPage8CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				...
				Collections
						.singletonList(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Page_2005));
		entry.setId("createPage8CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes
				.getImageDescriptor(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Page_2005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createViewAttribute11CreationTool() {
		...
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.ViewAttribute_2004);
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
	...
	private ToolEntry createNavegationMenu12CreationTool() {
		...
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.NavegationMenu_2009);
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
	...
	private ToolEntry createLinkView15CreationTool() {
		...
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.LinkView_2006);
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
	...
	private ToolEntry createConstraint16CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				...
				Collections
						.singletonList(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Constraint_2003));
		entry.setId("createConstraint16CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes
				.getImageDescriptor(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Constraint_2003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
