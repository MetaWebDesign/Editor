...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private Metawebdesign.metawebdesign.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new Metawebdesign.metawebdesign.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
