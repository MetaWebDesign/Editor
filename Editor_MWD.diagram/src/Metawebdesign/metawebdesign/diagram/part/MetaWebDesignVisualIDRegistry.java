...
public class MetaWebDesignVisualIDRegistry {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.FormEditPart.VISUAL_ID:
			...
			if (Metawebdesign.metawebdesign.diagram.edit.parts.FormCompViewEnCajonFromEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Metawebdesign.metawebdesign.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			...
			if (Metawebdesign.metawebdesign.diagram.edit.parts.ClassAtributoEnCajonClassEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.PageEditPart.VISUAL_ID:
			...
			if (Metawebdesign.metawebdesign.diagram.edit.parts.PageCompViewEnCajonPageEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuEditPart.VISUAL_ID:
			...
			if (Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenu2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenu2EditPart.VISUAL_ID:
			...
			if (Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuLinksEnCajonNavMenuEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
