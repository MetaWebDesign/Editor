...
public class MetaWebDesignModelingAssistantProviderOfRootEditPart
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Constraint_2003);
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.ViewAttribute_2004);
		types.add(Metawebdesign.metawebdesign.diagram.providers.MetaWebDesignElementTypes.Page_2005);
