...
public class MetaWebDesignElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Form_2001 = getElementType("Editor_MWD.diagram.Form_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static final IElementType Constraint_2003 = getElementType("Editor_MWD.diagram.Constraint_2003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ViewAttribute_2004 = getElementType("Editor_MWD.diagram.ViewAttribute_2004"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Page_2005 = getElementType("Editor_MWD.diagram.Page_2005"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Derived_2007 = getElementType("Editor_MWD.diagram.Derived_2007"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType LinkView_2006 = getElementType("Editor_MWD.diagram.LinkView_2006"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType LinkViewCRUD_2008 = getElementType("Editor_MWD.diagram.LinkViewCRUD_2008"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType NavegationMenu_2009 = getElementType("Editor_MWD.diagram.NavegationMenu_2009"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static final IElementType ViewAttribute_3001 = getElementType("Editor_MWD.diagram.ViewAttribute_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Constraint_2003,
					Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
							.getConstraint());

			elements.put(ViewAttribute_2004,
					Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
							.getViewAttribute());
			...
			elements.put(NavegationMenu_2009,
					Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
							.getNavegationMenu());
			...
			elements.put(ViewAttribute_3001,
					Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
							.getViewAttribute());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Constraint_2003);
			KNOWN_ELEMENT_TYPES.add(ViewAttribute_2004);
			KNOWN_ELEMENT_TYPES.add(Page_2005);
			KNOWN_ELEMENT_TYPES.add(Derived_2007);
			KNOWN_ELEMENT_TYPES.add(LinkView_2006);
			KNOWN_ELEMENT_TYPES.add(LinkViewCRUD_2008);
			KNOWN_ELEMENT_TYPES.add(NavegationMenu_2009);
			KNOWN_ELEMENT_TYPES.add(NotDerived_2010);
			KNOWN_ELEMENT_TYPES.add(ViewAttribute_3001);
