...
public class MetaWebDesignParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser viewAttributeName_5010Parser;

	/**
	 * @generated
	 */
	private IParser getViewAttributeName_5010Parser() {
		if (viewAttributeName_5010Parser == null) {
			EAttribute[] features = new EAttribute[] { Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
					.getViewAttribute_Name() };
			Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser parser = new Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser(
					features);
			viewAttributeName_5010Parser = parser;
		}
		return viewAttributeName_5010Parser;
	}

	/**
	 * @generated
	 */
	private IParser pageTitle_5011Parser;

	/**
	 * @generated
	 */
	private IParser getPageTitle_5011Parser() {
		if (pageTitle_5011Parser == null) {
			EAttribute[] features = new EAttribute[] { Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
					.getViews_Title() };
			Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser parser = new Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser(
					features);
			pageTitle_5011Parser = parser;
		}
		return pageTitle_5011Parser;
	}
	 ...
	 * @generated
	 */
	private IParser linkViewName_5012Parser;

	/**
	 * @generated
	 */
	private IParser getLinkViewName_5012Parser() {
		if (linkViewName_5012Parser == null) {
			EAttribute[] features = new EAttribute[] { Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
					.getLink_Name() };
			Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser parser = new Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser(
					features);
			linkViewName_5012Parser = parser;
		}
		return linkViewName_5012Parser;
	}
	 ...
	 * @generated
	 */
	private IParser navegationMenuName_5015Parser;

	/**
	 * @generated
	 */
	private IParser getNavegationMenuName_5015Parser() {
		if (navegationMenuName_5015Parser == null) {
			EAttribute[] features = new EAttribute[] { Metawebdesign.metawebdesign.MetawebdesignPackage.eINSTANCE
					.getNavegationMenu_Name() };
			Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser parser = new Metawebdesign.metawebdesign.diagram.parsers.MessageFormatParser(
					features);
			navegationMenuName_5015Parser = parser;
		}
		return navegationMenuName_5015Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.LinkViewNameEditPart.VISUAL_ID:
			return getLinkViewName_5012Parser();
		...
		case Metawebdesign.metawebdesign.diagram.edit.parts.NavegationMenuNameEditPart.VISUAL_ID:
			return getNavegationMenuName_5015Parser();
