...
/**
 * This is the item provider adapter for a {@link Metawebdesign.metawebdesign.Attributes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_name_feature", "_UI_Attributes_type"),
				 MetawebdesignPackage.Literals.ATTRIBUTES__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_rol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_rol_feature", "_UI_Attributes_type"),
				 MetawebdesignPackage.Literals.ATTRIBUTES__ROL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetawebdesignPackage.Literals.ATTRIBUTES__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPrimaryKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_primaryKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_primaryKey_feature", "_UI_Attributes_type"),
				 MetawebdesignPackage.Literals.ATTRIBUTES__PRIMARY_KEY,
				 true,
				 false,
				 false,
	...
	protected void addDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_dataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_dataType_feature", "_UI_Attributes_type"),
				 MetawebdesignPackage.Literals.ATTRIBUTES__DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInTheFormPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_inTheForm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_inTheForm_feature", "_UI_Attributes_type"),
				 MetawebdesignPackage.Literals.ATTRIBUTES__IN_THE_FORM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attributes.class)) {
			...
			case MetawebdesignPackage.ATTRIBUTES__VALUE:
