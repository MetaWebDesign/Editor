...
/**
 * This is the item provider adapter for a {@link Metawebdesign.metawebdesign.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetawebdesignPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_order_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_order_feature", "_UI_Group_type"),
				 MetawebdesignPackage.Literals.GROUP__ORDER,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Group.class)) {
			case MetawebdesignPackage.GROUP__NAME:
			case MetawebdesignPackage.GROUP__ORDER:
