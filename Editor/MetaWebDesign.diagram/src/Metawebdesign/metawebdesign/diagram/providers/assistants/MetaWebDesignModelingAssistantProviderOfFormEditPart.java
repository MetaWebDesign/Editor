...
public class MetaWebDesignModelingAssistantProviderOfFormEditPart
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Metawebdesign.metawebdesign.diagram.edit.parts.FormEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Metawebdesign.metawebdesign.diagram.edit.parts.FormEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Metawebdesign.metawebdesign.diagram.edit.parts.FormEditPart) targetEditPart,
				relationshipType);
	}
