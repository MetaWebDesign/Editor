 ...
 * @generated
 */
public class NavegationMenuNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NavegationMenuNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Metawebdesign.metawebdesign.diagram.edit.policies.MetaWebDesignTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					Metawebdesign.metawebdesign.diagram.edit.parts.MetaWebDesignEditPartFactory
