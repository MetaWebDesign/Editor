 ...
 *   <li>{@link Metawebdesign.metawebdesign.impl.AttributesImpl#getValue <em>Value</em>}</li>
...
public class AttributesImpl extends MinimalEObjectImpl.Container implements Attributes {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetawebdesignPackage.ATTRIBUTES__VALUE, oldValue, value));
	}
