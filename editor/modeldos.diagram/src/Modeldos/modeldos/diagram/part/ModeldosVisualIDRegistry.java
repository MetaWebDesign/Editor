...
public class ModeldosVisualIDRegistry {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case Modeldos.modeldos.diagram.edit.parts.MenuEditPart.VISUAL_ID:
			if (Modeldos.modeldos.diagram.edit.parts.MenuNombreEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Modeldos.modeldos.diagram.edit.parts.MenuGrupoInMenuFCajaEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Modeldos.modeldos.diagram.edit.parts.GroupEditPart.VISUAL_ID:
			if (Modeldos.modeldos.diagram.edit.parts.GroupNombreEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Modeldos.modeldos.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			...
			if (Modeldos.modeldos.diagram.edit.parts.ClassAttributeInClassCajaEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Modeldos.modeldos.diagram.edit.parts.Group2EditPart.VISUAL_ID:
			if (Modeldos.modeldos.diagram.edit.parts.GroupNombre2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Modeldos.modeldos.diagram.edit.parts.RelationClassEditPart.VISUAL_ID:
			if (Modeldos.modeldos.diagram.edit.parts.RelationClassRelationNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		}
