 ...
 * @generated
 */
public class DerivedEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.DerivedItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.DerivedNameEditPart) {
			((Modeldos.modeldos.diagram.edit.parts.DerivedNameEditPart) childEditPart)
	...
	public class DerivedFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureDerivedValorFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureDerivedValorFigure = new WrappingLabel();

			fFigureDerivedValorFigure.setText("<...>");

			this.add(fFigureDerivedValorFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDerivedValorFigure() {
			return fFigureDerivedValorFigure;
		}
