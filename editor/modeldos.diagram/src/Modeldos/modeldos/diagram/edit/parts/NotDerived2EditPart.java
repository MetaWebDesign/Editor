...
public class NotDerived2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.NotDerived2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.NotDerivedName2EditPart) {
			((Modeldos.modeldos.diagram.edit.parts.NotDerivedName2EditPart) childEditPart)
	...
	public class NotDerivedFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureNotDerivedValorFigure;
		/**
		 * @generated
		 */
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureNotDerivedDefaultValueFigure;
		...
		private void createContents() {
			...
			fFigureNotDerivedValorFigure = new WrappingLabel();

			fFigureNotDerivedValorFigure.setText("<...>");

			this.add(fFigureNotDerivedValorFigure);
			...
			fFigureNotDerivedDefaultValueFigure = new WrappingLabel();

			fFigureNotDerivedDefaultValueFigure.setText("<...>");

			this.add(fFigureNotDerivedDefaultValueFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureNotDerivedValorFigure() {
			return fFigureNotDerivedValorFigure;
		}
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureNotDerivedDefaultValueFigure() {
			return fFigureNotDerivedDefaultValueFigure;
		}
