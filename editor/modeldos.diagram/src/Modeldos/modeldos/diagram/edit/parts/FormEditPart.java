...
public class FormEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.FormItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.FormTitleEditPart) {
			((Modeldos.modeldos.diagram.edit.parts.FormTitleEditPart) childEditPart)
	...
	public class FormFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureFormGroupNameFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureFormGroupNameFigure = new WrappingLabel();

			fFigureFormGroupNameFigure.setText("<...>");

			this.add(fFigureFormGroupNameFigure);
			...
			this.add(fFigureFormNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFormGroupNameFigure() {
			return fFigureFormGroupNameFigure;
		}
