...
public class Derived2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.Derived2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.DerivedName2EditPart) {
			((Modeldos.modeldos.diagram.edit.parts.DerivedName2EditPart) childEditPart)
