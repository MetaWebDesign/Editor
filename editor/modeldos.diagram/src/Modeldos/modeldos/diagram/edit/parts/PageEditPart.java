...
public class PageEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.PageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.PageTitleEditPart) {
			((Modeldos.modeldos.diagram.edit.parts.PageTitleEditPart) childEditPart)
