...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.GroupName2EditPart) {
			((Modeldos.modeldos.diagram.edit.parts.GroupName2EditPart) childEditPart)
