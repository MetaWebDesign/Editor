 ...
 * @generated
 */
public class RelationClassRelationNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RelationClassRelationNameEditPart(View view) {
		super(view);
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					Modeldos.modeldos.diagram.edit.parts.ModeldosEditPartFactory
