...
public class NotDerivedEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeldos.modeldos.diagram.edit.policies.NotDerivedItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.NotDerivedNameEditPart) {
			((Modeldos.modeldos.diagram.edit.parts.NotDerivedNameEditPart) childEditPart)
