...
public class RootCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<Modeldos.modeldos.diagram.part.ModeldosNodeDescriptor> childDescriptors = Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
				.getRoot_1000SemanticChildren(viewObject);
		for (Modeldos.modeldos.diagram.part.ModeldosNodeDescriptor d : childDescriptors) {
	...
	protected void refreshSemantic() {
		...
		for (Iterator<Modeldos.modeldos.diagram.part.ModeldosNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			Modeldos.modeldos.diagram.part.ModeldosNodeDescriptor next = descriptorsIterator
					.next();
			String hint = Modeldos.modeldos.diagram.part.ModeldosVisualIDRegistry
		...
		for (Modeldos.modeldos.diagram.part.ModeldosNodeDescriptor next : childDescriptors) {
			String hint = Modeldos.modeldos.diagram.part.ModeldosVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = Modeldos.modeldos.diagram.part.ModeldosVisualIDRegistry
			...
			for (Iterator<Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor> collectAllLinks(
		...
		case Modeldos.modeldos.diagram.edit.parts.MenuEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
						.getMenu_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case Modeldos.modeldos.diagram.edit.parts.NotDerivedEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
						.getNotDerived_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modeldos.modeldos.diagram.edit.parts.NotDerived2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
						.getNotDerived_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modeldos.modeldos.diagram.edit.parts.Derived2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
						.getDerived_3002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modeldos.modeldos.diagram.edit.parts.Group2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modeldos.modeldos.diagram.part.ModeldosDiagramUpdater
						.getGroup_3003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (Modeldos.modeldos.diagram.part.ModeldosLinkDescriptor nextLinkDescriptor : linkDescriptors) {
