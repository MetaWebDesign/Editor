...
/**
 * This is the item provider adapter for a {@link Modeldos.modeldos.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider extends ViewsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModeldosPackage.Literals.FORM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addServicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_service_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_service_feature", "_UI_Form_type"),
				 ModeldosPackage.Literals.FORM__SERVICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Form.class)) {
			case ModeldosPackage.FORM__NAME:
			case ModeldosPackage.FORM__SERVICE:
