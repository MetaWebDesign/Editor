 ...
 *   <li>{@link Modeldos.modeldos.Root#getPresentationunit <em>Presentationunit</em>}</li>
...
public interface Root extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Presentationunit</b></em>' containment reference list.
	 * The list contents are of type {@link Modeldos.modeldos.PresentationUnit}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Presentationunit</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Presentationunit</em>' containment reference list.
	 * @see Modeldos.modeldos.ModeldosPackage#getRoot_Presentationunit()
	 * @model containment="true"
	 * @generated
	 */
	EList<PresentationUnit> getPresentationunit();
