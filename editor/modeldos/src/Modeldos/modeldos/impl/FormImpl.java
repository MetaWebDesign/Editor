 ...
 * <ul>
 *   <li>{@link Modeldos.modeldos.impl.FormImpl#getName <em>Name</em>}</li>
 *   <li>{@link Modeldos.modeldos.impl.FormImpl#getService <em>Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FormImpl extends ViewsImpl implements Form {
	/**
	...
	protected EClass eStaticClass() {
		return ModeldosPackage.Literals.FORM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldosPackage.FORM__NAME, oldName, name));
	}
	...
	public void setService(TypeService newService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldosPackage.FORM__SERVICE, oldService, service));
	}
