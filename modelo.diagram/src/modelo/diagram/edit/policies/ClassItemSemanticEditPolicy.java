...
import modelo.diagram.edit.commands.RelationCreateCommand;
import modelo.diagram.edit.commands.RelationReorientCommand;
...
public class ClassItemSemanticEditPolicy extends
	...
	public ClassItemSemanticEditPolicy() {
		super(ModeloElementTypes.Class_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModeloVisualIDRegistry.getVisualID(incomingLink) == RelationEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModeloVisualIDRegistry.getVisualID(outgoingLink) == RelationEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ModeloElementTypes.Relation_4001 == req.getElementType()) {
