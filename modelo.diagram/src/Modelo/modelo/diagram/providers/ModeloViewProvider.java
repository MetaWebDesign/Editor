 ...
 * @generated
 */
public class ModeloViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Modelo.modelo.diagram.part.ModeloVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = Modelo.modelo.diagram.part.ModeloVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!Modelo.modelo.diagram.providers.ModeloElementTypes
		...
		return Modelo.modelo.diagram.edit.parts.ClassEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(Modelo.modelo.diagram.edit.parts.ModelEditPart.MODEL_ID);
	...
	public Node createClass_2001(EObject domainElement, View containerView,
		...
		node.setType(Modelo.modelo.diagram.part.ModeloVisualIDRegistry
				.getType(Modelo.modelo.diagram.edit.parts.ClassEditPart.VISUAL_ID));
	...
	public Edge createRelation_4001(EObject domainElement, View containerView,
		...
		edge.setType(Modelo.modelo.diagram.part.ModeloVisualIDRegistry
				.getType(Modelo.modelo.diagram.edit.parts.RelationEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!Modelo.modelo.diagram.edit.parts.ModelEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", Modelo.modelo.diagram.edit.parts.ModelEditPart.MODEL_ID); //$NON-NLS-1$
