...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modelo.modelo.diagram.edit.policies.ClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modelo.modelo.diagram.edit.parts.ClassNameEditPart) {
			((Modelo.modelo.diagram.edit.parts.ClassNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Modelo.modelo.diagram.part.ModeloVisualIDRegistry
