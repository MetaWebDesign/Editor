...
public class ClassNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modelo.modelo.diagram.edit.policies.ModeloTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Modelo.modelo.diagram.providers.ModeloParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					Modelo.modelo.diagram.edit.parts.ModeloEditPartFactory
