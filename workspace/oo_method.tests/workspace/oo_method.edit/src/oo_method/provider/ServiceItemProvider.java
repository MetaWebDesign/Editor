...
/**
 * This is the item provider adapter for a {@link oo_method.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Oo_methodPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Oo_methodPackage.Literals.SERVICE__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Oo_methodPackage.Literals.SERVICE__ARGUMENTS);
			childrenFeatures.add(Oo_methodPackage.Literals.SERVICE__PRECONDITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Oo_methodPackage.Literals.SERVICE__ARGUMENTS,
				 Oo_methodFactory.eINSTANCE.createArgument()));

		newChildDescriptors.add
			(createChildParameter
				(Oo_methodPackage.Literals.SERVICE__PRECONDITIONS,
				 Oo_methodFactory.eINSTANCE.createPrecondition()));
	}
