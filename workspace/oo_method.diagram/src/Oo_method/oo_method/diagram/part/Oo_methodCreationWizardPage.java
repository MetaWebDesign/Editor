 ...
 * @generated
 */
public class Oo_methodCreationWizardPage extends WizardNewFileCreationPage {
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS
					.bind(Oo_method.oo_method.diagram.part.Messages.Oo_methodCreationWizardPageExtensionError,
							extension));
			return false;
		}
		return true;
