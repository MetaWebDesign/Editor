...
public class DiagramEditorWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {
	...
	public ActionBarAdvisor createActionBarAdvisor(
		...
		return new oo_method.diagram.application.DiagramEditorActionBarAdvisor(
				configurer);
	}
	...
	public void preWindowOpen() {
		...
		configurer
				.setTitle(oo_method.diagram.part.Messages.DiagramEditorWorkbenchWindowAdvisor_Title);
	}
