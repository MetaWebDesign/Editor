...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					oo_method.diagram.part.Messages.ApplicationMenuName_File,
...

			{
				IMenuManager menuXX = new MenuManager(
						oo_method.diagram.part.Messages.ApplicationMenuName_New,
						"new");
		...
		{
			IMenuManager menuX = new MenuManager(
					oo_method.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(
					oo_method.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(
					oo_method.diagram.part.Messages.ApplicationMenuName_Help,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							oo_method.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS.bind(
									oo_method.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								oo_method.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			oo_method.diagram.part.Oo_methodCreationWizard wizard = new oo_method.diagram.part.Oo_methodCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							oo_method.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							oo_method.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
