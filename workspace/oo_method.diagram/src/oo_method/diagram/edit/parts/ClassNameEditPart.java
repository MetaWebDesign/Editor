...
public class ClassNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new oo_method.diagram.edit.policies.Oo_methodTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new oo_method.diagram.edit.parts.StructuralModelEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return oo_method.diagram.providers.Oo_methodElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = oo_method.diagram.providers.Oo_methodParserProvider
					.getParser(
							oo_method.diagram.providers.Oo_methodElementTypes.Class_2001,
							getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					oo_method.diagram.edit.parts.Oo_methodEditPartFactory
