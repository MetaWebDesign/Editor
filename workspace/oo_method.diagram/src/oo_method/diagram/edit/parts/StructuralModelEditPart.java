...
public class StructuralModelEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new oo_method.diagram.edit.policies.StructuralModelItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new oo_method.diagram.edit.policies.StructuralModelCanonicalEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						oo_method.diagram.part.Oo_methodVisualIDRegistry.TYPED_INSTANCE));
