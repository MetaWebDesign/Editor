...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new oo_method.diagram.edit.policies.ClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof oo_method.diagram.edit.parts.ClassNameEditPart) {
			((oo_method.diagram.edit.parts.ClassNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(oo_method.diagram.part.Oo_methodVisualIDRegistry
