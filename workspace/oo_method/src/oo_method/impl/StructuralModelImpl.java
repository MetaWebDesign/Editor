...
public class StructuralModelImpl extends MinimalEObjectImpl.Container implements StructuralModel {
	 ...
	 * @ordered
	 */
	protected EList<oo_method.Class> classes;
	 ...
	 * @generated
	 */
	public EList<oo_method.Class> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList<oo_method.Class>(oo_method.Class.class, this, Oo_methodPackage.STRUCTURAL_MODEL__CLASSES);
		}
		return classes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Oo_methodPackage.STRUCTURAL_MODEL__CLASSES:
				getClasses().clear();
				getClasses().addAll((Collection<? extends oo_method.Class>)newValue);
				return;
		}
