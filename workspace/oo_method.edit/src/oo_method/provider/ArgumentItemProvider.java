...
/**
 * This is the item provider adapter for a {@link oo_method.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Oo_methodPackage.Literals.ARGUMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDefaultValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_defaultValue_feature", "_UI_Argument_type"),
				 Oo_methodPackage.Literals.ARGUMENT__DEFAULT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
