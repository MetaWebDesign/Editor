...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	 ...
	 * @ordered
	 */
	protected metamodel.Class component;
	 ...
	 * @generated
	 */
	public metamodel.Class getComposed() {
		if (eContainerFeatureID() != Oo_methodPackage.RELATION__COMPOSED) return null;
		return (metamodel.Class)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComposed(metamodel.Class newComposed, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setComposed(metamodel.Class newComposed) {
		if (newComposed != eInternalContainer() || (eContainerFeatureID() != Oo_methodPackage.RELATION__COMPOSED && newComposed != null)) {
			...
			if (newComposed != null)
				msgs = ((InternalEObject)newComposed).eInverseAdd(this, Oo_methodPackage.CLASS__RCOMPOUND, metamodel.Class.class, msgs);
	 ...
	 * @generated
	 */
	public metamodel.Class getComponent() {
		if (component != null && component.eIsProxy()) {
			InternalEObject oldComponent = (InternalEObject)component;
			component = (metamodel.Class)eResolveProxy(oldComponent);
	 ...
	 * @generated
	 */
	public metamodel.Class basicGetComponent() {
		return component;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComponent(metamodel.Class newComponent, NotificationChain msgs) {
		metamodel.Class oldComponent = component;
	 ...
	 * @generated
	 */
	public void setComponent(metamodel.Class newComponent) {
		if (newComponent != component) {
			NotificationChain msgs = null;
			if (component != null)
				msgs = ((InternalEObject)component).eInverseRemove(this, Oo_methodPackage.CLASS__RCOMPONENTS, metamodel.Class.class, msgs);
			if (newComponent != null)
				msgs = ((InternalEObject)newComponent).eInverseAdd(this, Oo_methodPackage.CLASS__RCOMPONENTS, metamodel.Class.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Oo_methodPackage.RELATION__COMPOSED:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetComposed((metamodel.Class)otherEnd, msgs);
			case Oo_methodPackage.RELATION__COMPONENT:
				if (component != null)
					msgs = ((InternalEObject)component).eInverseRemove(this, Oo_methodPackage.CLASS__RCOMPONENTS, metamodel.Class.class, msgs);
				return basicSetComponent((metamodel.Class)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Oo_methodPackage.RELATION__COMPOSED:
				return eInternalContainer().eInverseRemove(this, Oo_methodPackage.CLASS__RCOMPOUND, metamodel.Class.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Oo_methodPackage.RELATION__COMPOSED:
				setComposed((metamodel.Class)newValue);
				return;
			case Oo_methodPackage.RELATION__COMPONENT:
				setComponent((metamodel.Class)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Oo_methodPackage.RELATION__COMPOSED:
				setComposed((metamodel.Class)null);
				return;
			case Oo_methodPackage.RELATION__COMPONENT:
				setComponent((metamodel.Class)null);
				return;
		}
