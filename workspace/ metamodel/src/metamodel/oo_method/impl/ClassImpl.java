 ...
 * <ul>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getRCompound <em>RCompound</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getRComponents <em>RComponents</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getIdFunction <em>Id Function</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getServices <em>Services</em>}</li>
 *   <li>{@link oo_method.oo_method.impl.ClassImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassImpl extends MinimalEObjectImpl.Container implements metamodel.oo_method.Class {
	/**
