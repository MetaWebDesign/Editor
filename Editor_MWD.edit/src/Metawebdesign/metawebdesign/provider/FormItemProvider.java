...
/**
 * This is the item provider adapter for a {@link Metawebdesign.metawebdesign.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider extends ViewsItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetawebdesignPackage.Literals.FORM__SERVICE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Form.class)) {
			case MetawebdesignPackage.FORM__SERVICE:
