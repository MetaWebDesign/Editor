...
/**
 * This is the item provider adapter for a {@link kk.modelo.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModeloPackage.Literals.CLASS__CNAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModeloPackage.Literals.CLASS__HAS_ATRIBUTTE);
		}
	...
	public String getText(Object object) {
		String label = ((kk.modelo.Class)object).getCname();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(kk.modelo.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModeloPackage.Literals.CLASS__HAS_ATRIBUTTE,
				 ModeloFactory.eINSTANCE.createAtributo()));
	}
