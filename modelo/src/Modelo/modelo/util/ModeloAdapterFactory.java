 ...
 * <!-- end-user-doc -->
 * @see Modelo.modelo.ModeloPackage
 * @generated
 */
public class ModeloAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModeloSwitch<Adapter> modelSwitch =
		new ModeloSwitch<Adapter>() {
			...
			@Override
			public Adapter caseClass(Modelo.modelo.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link Modelo.modelo.Model <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Modelo.modelo.Class <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Modelo.modelo.Relation <em>Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
