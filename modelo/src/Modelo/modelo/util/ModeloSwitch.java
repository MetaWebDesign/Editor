...
public class ModeloSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModeloPackage.CLASS: {
				Modelo.modelo.Class class_ = (Modelo.modelo.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModeloPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModeloPackage.ATTRIBUTE: {
	 ...
	 * @generated
	 */
	public T caseClass(Modelo.modelo.Class object) {
		return null;
	}
