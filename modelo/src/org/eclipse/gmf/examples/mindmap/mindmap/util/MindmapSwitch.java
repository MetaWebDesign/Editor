...
public class MindmapSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MindmapPackage.THREAD: {
				org.eclipse.gmf.examples.mindmap.mindmap.Thread thread = (org.eclipse.gmf.examples.mindmap.mindmap.Thread)theEObject;
	 ...
	 * @generated
	 */
	public T caseThread(org.eclipse.gmf.examples.mindmap.mindmap.Thread object) {
		return null;
	}
