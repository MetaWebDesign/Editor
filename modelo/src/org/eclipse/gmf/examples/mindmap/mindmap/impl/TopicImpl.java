 ...
 * <ul>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getPercentComplete <em>Percent Complete</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link org.eclipse.gmf.examples.mindmap.mindmap.impl.TopicImpl#getSubtopics <em>Subtopics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TopicImpl extends MinimalEObjectImpl.Container implements Topic {
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.gmf.examples.mindmap.mindmap.Thread> comments;
	 ...
	 * @generated
	 */
	public EList<org.eclipse.gmf.examples.mindmap.mindmap.Thread> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentEList<org.eclipse.gmf.examples.mindmap.mindmap.Thread>(org.eclipse.gmf.examples.mindmap.mindmap.Thread.class, this, MindmapPackage.TOPIC__COMMENTS);
		}
		return comments;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MindmapPackage.TOPIC__COMMENTS:
				getComments().clear();
				getComments().addAll((Collection<? extends org.eclipse.gmf.examples.mindmap.mindmap.Thread>)newValue);
				return;
			case MindmapPackage.TOPIC__DURATION:
