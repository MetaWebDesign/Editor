/**
 */
package kk.modelo.util;

import kk.modelo.Atributo;
import kk.modelo.Model;
...
public class ModeloAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModeloSwitch<Adapter> modelSwitch =
		new ModeloSwitch<Adapter>() {
			...
			@Override
			public Adapter caseClass(kk.modelo.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link kk.modelo.Model <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link kk.modelo.Class <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link kk.modelo.Atributo <em>Atributo</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
