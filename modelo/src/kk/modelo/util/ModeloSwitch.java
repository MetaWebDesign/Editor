...
public class ModeloSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModeloPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModeloPackage.CLASS: {
				kk.modelo.Class class_ = (kk.modelo.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModeloPackage.ATRIBUTO: {
	 ...
	 * @generated
	 */
	public T caseClass(kk.modelo.Class object) {
		return null;
	}
