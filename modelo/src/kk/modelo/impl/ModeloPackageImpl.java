...
public class ModeloPackageImpl extends EPackageImpl implements ModeloPackage {
	 ...
	 * @see kk.modelo.ModeloPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getClass_HasAtributte() {
	...
	public void createPackageContents() {
		...
		createEReference(classEClass, CLASS__HAS_ATRIBUTTE);
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, kk.modelo.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Cname(), ecorePackage.getEString(), "Cname", null, 0, 1, kk.modelo.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_HasAtributte(), this.getAtributo(), null, "hasAtributte", null, 0, 1, kk.modelo.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
