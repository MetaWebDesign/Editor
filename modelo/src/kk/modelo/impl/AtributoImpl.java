 ...
 * <ul>
 *   <li>{@link kk.modelo.impl.AtributoImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AtributoImpl extends MinimalEObjectImpl.Container implements Atributo {
	...
	protected EClass eStaticClass() {
		return ModeloPackage.Literals.ATRIBUTO;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeloPackage.ATRIBUTO__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModeloPackage.ATRIBUTO__NAME:
				return getName();
		}
