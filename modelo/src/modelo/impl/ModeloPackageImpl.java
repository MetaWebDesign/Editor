...
public class ModeloPackageImpl extends EPackageImpl implements ModeloPackage {
	 ...
	 * @generated
	 */
	public EReference getClass_HasRelaction() {
	 ...
	 * @generated
	 */
	public EReference getClass_From() {
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, modelo.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_HasRelaction(), this.getRelation(), null, "hasRelaction", null, 0, -1, modelo.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_From(), this.getRelation(), null, "from", null, 0, -1, modelo.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
