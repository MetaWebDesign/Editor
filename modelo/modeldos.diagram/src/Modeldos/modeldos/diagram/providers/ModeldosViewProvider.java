...
public class ModeldosViewProvider extends AbstractProvider implements
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(Modeldos.modeldos.diagram.edit.parts.MapEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case Modeldos.modeldos.diagram.edit.parts.AtributteEditPart.VISUAL_ID:
			return createAtributte_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createRelation_4001(EObject domainElement, View containerView,
		...
		edge.setType(Modeldos.modeldos.diagram.part.ModeldosVisualIDRegistry
				.getType(Modeldos.modeldos.diagram.edit.parts.RelationEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createAtributte_4002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Modeldos.modeldos.diagram.part.ModeldosVisualIDRegistry
				.getType(Modeldos.modeldos.diagram.edit.parts.AtributteEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!Modeldos.modeldos.diagram.edit.parts.MapEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", Modeldos.modeldos.diagram.edit.parts.MapEditPart.MODEL_ID); //$NON-NLS-1$
