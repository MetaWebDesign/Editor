...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeldos.modeldos.diagram.edit.parts.ClassCnameEditPart) {
			((Modeldos.modeldos.diagram.edit.parts.ClassCnameEditPart) childEditPart)
