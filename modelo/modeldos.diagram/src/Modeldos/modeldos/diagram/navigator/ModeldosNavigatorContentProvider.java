	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case Modeldos.modeldos.diagram.edit.parts.MapEditPart.VISUAL_ID: {
			...
			Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup links = new Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup(
					Modeldos.modeldos.diagram.part.Messages.NavigatorGroupName_Map_1000_links,
		...
		case Modeldos.modeldos.diagram.edit.parts.RelationEditPart.VISUAL_ID: {
			...
			Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup target = new Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup(
					Modeldos.modeldos.diagram.part.Messages.NavigatorGroupName_Relation_4001_target,
			...
			Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup source = new Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup(
					Modeldos.modeldos.diagram.part.Messages.NavigatorGroupName_Relation_4001_source,
		...
		case Modeldos.modeldos.diagram.edit.parts.AtributteEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup target = new Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup(
					Modeldos.modeldos.diagram.part.Messages.NavigatorGroupName_Atributte_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup source = new Modeldos.modeldos.diagram.navigator.ModeldosNavigatorGroup(
					Modeldos.modeldos.diagram.part.Messages.NavigatorGroupName_Atributte_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(
					Collections.singleton(sv),
