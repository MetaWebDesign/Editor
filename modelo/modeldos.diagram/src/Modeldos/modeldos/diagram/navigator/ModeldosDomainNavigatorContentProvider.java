 ...
 * @generated
 */
public class ModeldosDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ModeldosDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Modeldos.modeldos.diagram.navigator.ModeldosDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Modeldos.modeldos.diagram.navigator.ModeldosDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Modeldos.modeldos.diagram.navigator.ModeldosDomainNavigatorItem(
