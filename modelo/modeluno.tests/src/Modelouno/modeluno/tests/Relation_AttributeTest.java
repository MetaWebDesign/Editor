 ...
 * @generated
 */
public class Relation_AttributeTest extends TestCase {
	 ...
	 * @generated
	 */
	protected Relation_Attribute fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(Relation_AttributeTest.class);
	}
	 ...
	 * @generated
	 */
	public Relation_AttributeTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(Relation_Attribute fixture) {
	 ...
	 * @generated
	 */
	protected Relation_Attribute getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ModelunoFactory.eINSTANCE.createRelation_Attribute());
	}
