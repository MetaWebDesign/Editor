...
public class ModelunoElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Attribute_Derived_2001 = getElementType("modeluno.diagram.Attribute_Derived_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Class_2002 = getElementType("modeluno.diagram.Class_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Attribute_Not_Derived_2003 = getElementType("modeluno.diagram.Attribute_Not_Derived_2003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Attribute_Relation_4001 = getElementType("modeluno.diagram.Attribute_Relation_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Class_Relation_4002 = getElementType("modeluno.diagram.Class_Relation_4002"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Attribute_Derived_2001,
			...
			elements.put(Attribute_Not_Derived_2003,
					Modeluno.modeluno.ModelunoPackage.eINSTANCE
							.getAttribute_Not_Derived());

			elements.put(Attribute_Relation_4001,
					Modeluno.modeluno.ModelunoPackage.eINSTANCE
							.getAttribute_Relation());

			elements.put(Class_Relation_4002,
					Modeluno.modeluno.ModelunoPackage.eINSTANCE
							.getClass_Relation());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Attribute_Derived_2001);
			KNOWN_ELEMENT_TYPES.add(Class_2002);
			KNOWN_ELEMENT_TYPES.add(Attribute_Not_Derived_2003);
			KNOWN_ELEMENT_TYPES.add(Attribute_Relation_4001);
			KNOWN_ELEMENT_TYPES.add(Class_Relation_4002);
		}
