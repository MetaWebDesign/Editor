...
public class ModelunoModelingAssistantProviderOfPageEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modeluno.modeluno.diagram.edit.parts.PageEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modeluno.modeluno.diagram.edit.parts.PageEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modeluno.modeluno.diagram.edit.parts.PageEditPart) targetEditPart,
				relationshipType);
	}
