...
public class ModelunoModelingAssistantProviderOfViewUpdateObjectEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modeluno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modeluno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modeluno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart) targetEditPart,
				relationshipType);
	}
