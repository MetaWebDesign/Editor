...
public class ModelunoModelingAssistantProviderOfViewIndexEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modeluno.modeluno.diagram.edit.parts.ViewIndexEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modeluno.modeluno.diagram.edit.parts.ViewIndexEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modeluno.modeluno.diagram.edit.parts.ViewIndexEditPart) targetEditPart,
				relationshipType);
	}
