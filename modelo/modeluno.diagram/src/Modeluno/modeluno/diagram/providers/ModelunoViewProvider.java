...
public class ModelunoViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return Modeluno.modeluno.diagram.edit.parts.ClassEditPart.VISUAL_ID == visualID
				...
				|| Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case Modeluno.modeluno.diagram.edit.parts.Attribute_Not_DerivedEditPart.VISUAL_ID:
			return createAttribute_Not_Derived_2008(domainElement,
					containerView, index, persisted, preferencesHint);
		case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID:
			return createConstraints_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case Modeluno.modeluno.diagram.edit.parts.Attribute_DerivedEditPart.VISUAL_ID:
			return createAttribute_Derived_2010(domainElement, containerView,
	 ...
	 * @generated
	 */
	public Node createAttribute_Not_Derived_2008(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createConstraints_2009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
				.getType(Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createAttribute_Derived_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createConstraints_Relation_4007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
				.getType(Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClass_Relation_4008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAttribute_Relation_4009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
