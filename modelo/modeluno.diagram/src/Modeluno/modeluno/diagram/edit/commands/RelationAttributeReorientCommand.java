 ...
 * @generated
 */
public class RelationAttributeReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RelationAttributeReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Modeluno.modeluno.RelationAttribute) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return Modeluno.modeluno.diagram.edit.policies.ModelunoBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRelationAttribute_4003(getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected Modeluno.modeluno.RelationAttribute getLink() {
		return (Modeluno.modeluno.RelationAttribute) getElementToEdit();
	}
