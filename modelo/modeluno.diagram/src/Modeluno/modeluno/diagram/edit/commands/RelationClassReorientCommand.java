...
public class RelationClassReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Modeluno.modeluno.RelationClass) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return Modeluno.modeluno.diagram.edit.policies.ModelunoBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRelationClass_4005(getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected Modeluno.modeluno.RelationClass getLink() {
		return (Modeluno.modeluno.RelationClass) getElementToEdit();
	}
