 ...
 * @generated
 */
public class ANotDerivedItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ANotDerivedItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
					.getVisualID(incomingLink) == Modeluno.modeluno.diagram.edit.parts.RAttributeEditPart.VISUAL_ID) {
