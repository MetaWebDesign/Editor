...
public class MapItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Class_2007 == req
				.getElementType()) {
			return getGEFWrapper(new Modeluno.modeluno.diagram.edit.commands.ClassCreateCommand(
					req));
		}
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Not_Derived_2008 == req
				.getElementType()) {
			return getGEFWrapper(new Modeluno.modeluno.diagram.edit.commands.Attribute_Not_DerivedCreateCommand(
					req));
		}
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Constraints_2009 == req
				.getElementType()) {
			return getGEFWrapper(new Modeluno.modeluno.diagram.edit.commands.ConstraintsCreateCommand(
					req));
		}
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Derived_2010 == req
				.getElementType()) {
