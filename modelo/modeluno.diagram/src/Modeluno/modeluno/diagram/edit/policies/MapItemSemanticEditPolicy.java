...
public class MapItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Atributte_2002 == req
				.getElementType()) {
			return getGEFWrapper(new Modeluno.modeluno.diagram.edit.commands.AtributteCreateCommand(
					req));
		}
		if (Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Class_2001 == req
				.getElementType()) {
