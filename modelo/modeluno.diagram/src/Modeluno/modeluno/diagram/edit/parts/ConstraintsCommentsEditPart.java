 ...
 * @generated
 */
public class ConstraintsCommentsEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConstraintsCommentsEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeluno.modeluno.diagram.edit.policies.ModelunoTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					Modeluno.modeluno.diagram.edit.parts.ModelunoEditPartFactory
