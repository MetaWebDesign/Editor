	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID:
				return new Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart(
						view);

			case Modeluno.modeluno.diagram.edit.parts.ConstraintsCommentsEditPart.VISUAL_ID:
				return new Modeluno.modeluno.diagram.edit.parts.ConstraintsCommentsEditPart(
						view);
			...
			case Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID:
				return new Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart(
						view);
