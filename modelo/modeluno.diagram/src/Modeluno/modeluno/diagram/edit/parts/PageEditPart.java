...
public class PageEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modeluno.modeluno.diagram.edit.policies.PageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Modeluno.modeluno.diagram.edit.parts.PageTitleEditPart) {
			((Modeluno.modeluno.diagram.edit.parts.PageTitleEditPart) childEditPart)
