...
public class ModelunoDiagramUpdater {
	...
	public static List<Modeluno.modeluno.diagram.part.ModelunoNodeDescriptor> getMap_1000SemanticChildren(
		...
		for (Iterator<?> it = modelElement.getHasAtribute().iterator(); it
				.hasNext();) {
			...
			if (visualID == Modeluno.modeluno.diagram.edit.parts.AtributteEditPart.VISUAL_ID) {
	...
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getContainedLinks(
		...
		case Modeluno.modeluno.diagram.edit.parts.AtributteEditPart.VISUAL_ID:
			return getAtributte_2002ContainedLinks(view);
		...
		case Modeluno.modeluno.diagram.edit.parts.RAttributeEditPart.VISUAL_ID:
			return getRAttribute_4002ContainedLinks(view);
		}
		return Collections.emptyList();
	}
	...
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getIncomingLinks(
		...
		switch (Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
				.getVisualID(view)) {
		case Modeluno.modeluno.diagram.edit.parts.AtributteEditPart.VISUAL_ID:
			return getAtributte_2002IncomingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			return getClass_2001IncomingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.RelationEditPart.VISUAL_ID:
			return getRelation_4001IncomingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.RAttributeEditPart.VISUAL_ID:
			return getRAttribute_4002IncomingLinks(view);
		}
		return Collections.emptyList();
	}
	...
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getOutgoingLinks(
		...
		switch (Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
				.getVisualID(view)) {
		case Modeluno.modeluno.diagram.edit.parts.AtributteEditPart.VISUAL_ID:
			return getAtributte_2002OutgoingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			return getClass_2001OutgoingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.RelationEditPart.VISUAL_ID:
			return getRelation_4001OutgoingLinks(view);
		case Modeluno.modeluno.diagram.edit.parts.RAttributeEditPart.VISUAL_ID:
			return getRAttribute_4002OutgoingLinks(view);
		}
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getAtributte_2002ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	...
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getClass_2001ContainedLinks(
		...
		result.addAll(getContainedTypeModelFacetLinks_RAttribute_4002(modelElement));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getRAttribute_4002ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getAtributte_2002IncomingLinks(
			View view) {
		Modeluno.modeluno.Atributte modelElement = (Modeluno.modeluno.Atributte) view
				.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> result = new LinkedList<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor>();
		result.addAll(getIncomingTypeModelFacetLinks_RAttribute_4002(
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getRAttribute_4002IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getAtributte_2002OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getRAttribute_4002OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	private static Collection<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getContainedTypeModelFacetLinks_RAttribute_4002(
			Modeluno.modeluno.Class container) {
		LinkedList<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> result = new LinkedList<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor>();
	 ...
	 * @generated
	 */
	private static Collection<Modeluno.modeluno.diagram.part.ModelunoLinkDescriptor> getIncomingTypeModelFacetLinks_RAttribute_4002(
