...
public class ModelunoVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case Modeluno.modeluno.diagram.edit.parts.MapEditPart.VISUAL_ID:
			...
			if (Modeluno.modeluno.ModelunoPackage.eINSTANCE.getConstraints()
					.isSuperTypeOf(domainElement.eClass())) {
				return Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID;
			}
			if (Modeluno.modeluno.ModelunoPackage.eINSTANCE
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case Modeluno.modeluno.diagram.edit.parts.MapEditPart.VISUAL_ID:
			...
			if (Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID:
			if (Modeluno.modeluno.diagram.edit.parts.ConstraintsCommentsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (Modeluno.modeluno.ModelunoPackage.eINSTANCE
				...
				.isSuperTypeOf(domainElement.eClass())) {
			return Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID;
		}
