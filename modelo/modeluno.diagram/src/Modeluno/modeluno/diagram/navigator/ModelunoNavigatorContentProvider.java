	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case Modeluno.modeluno.diagram.edit.parts.ClassEditPart.VISUAL_ID: {
			...
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup outgoinglinks = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Class_2007_outgoinglinks,
			...
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup incominglinks = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Class_2007_incominglinks,
		...
		case Modeluno.modeluno.diagram.edit.parts.Attribute_Not_DerivedEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup incominglinks = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Attribute_Not_Derived_2008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(
					Collections.singleton(sv),
		...
		case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup incominglinks = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Constraints_2009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(
					Collections.singleton(sv),
		...
		case Modeluno.modeluno.diagram.edit.parts.Attribute_DerivedEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup incominglinks = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Attribute_Derived_2010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(
					Collections.singleton(sv),
		...
		case Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID: {
			...
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup target = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Constraints_Relation_4007_target,
			...
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup source = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Constraints_Relation_4007_source,
		...
		case Modeluno.modeluno.diagram.edit.parts.Class_RelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup target = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Class_Relation_4008_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup source = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Class_Relation_4008_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(
					Collections.singleton(sv),
		...
		case Modeluno.modeluno.diagram.edit.parts.Attribute_RelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup target = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Attribute_Relation_4009_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup source = new Modeluno.modeluno.diagram.navigator.ModelunoNavigatorGroup(
					Modeluno.modeluno.diagram.part.Messages.NavigatorGroupName_Attribute_Relation_4009_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(
					Collections.singleton(sv),
