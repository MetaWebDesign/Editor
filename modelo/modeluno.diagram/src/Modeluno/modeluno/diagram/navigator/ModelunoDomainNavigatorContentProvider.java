...
public class ModelunoDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Modeluno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Modeluno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Modeluno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem(
