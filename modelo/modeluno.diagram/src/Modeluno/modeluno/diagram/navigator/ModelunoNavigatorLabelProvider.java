...
public class ModelunoNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case Modeluno.modeluno.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://modeluno/1.0?Class", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Class_2007); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.Attribute_Not_DerivedEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://modeluno/1.0?Attribute_Not_Derived", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Not_Derived_2008); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://modeluno/1.0?Constraints", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Constraints_2009); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.Attribute_DerivedEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://modeluno/1.0?Attribute_Derived", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Derived_2010); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://modeluno/1.0?Constraints_Relation", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Constraints_Relation_4007); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.Class_RelationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://modeluno/1.0?Class_Relation", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Class_Relation_4008); //$NON-NLS-1$
		case Modeluno.modeluno.diagram.edit.parts.Attribute_RelationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://modeluno/1.0?Attribute_Relation", Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Relation_4009); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case Modeluno.modeluno.diagram.edit.parts.Attribute_Not_DerivedEditPart.VISUAL_ID:
			return getAttribute_Not_Derived_2008Text(view);
		case Modeluno.modeluno.diagram.edit.parts.ConstraintsEditPart.VISUAL_ID:
			return getConstraints_2009Text(view);
		case Modeluno.modeluno.diagram.edit.parts.Attribute_DerivedEditPart.VISUAL_ID:
			return getAttribute_Derived_2010Text(view);
		case Modeluno.modeluno.diagram.edit.parts.Constraints_RelationEditPart.VISUAL_ID:
			return getConstraints_Relation_4007Text(view);
		case Modeluno.modeluno.diagram.edit.parts.Class_RelationEditPart.VISUAL_ID:
			return getClass_Relation_4008Text(view);
		case Modeluno.modeluno.diagram.edit.parts.Attribute_RelationEditPart.VISUAL_ID:
			return getAttribute_Relation_4009Text(view);
		}
	...
	private String getClass_2007Text(View view) {
		IParser parser = Modeluno.modeluno.diagram.providers.ModelunoParserProvider
				.getParser(
						Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Class_2007,
	 ...
	 * @generated
	 */
	private String getAttribute_Not_Derived_2008Text(View view) {
		IParser parser = Modeluno.modeluno.diagram.providers.ModelunoParserProvider
				.getParser(
						Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Not_Derived_2008,
						view.getElement() != null ? view.getElement() : view,
						Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getConstraints_2009Text(View view) {
		IParser parser = Modeluno.modeluno.diagram.providers.ModelunoParserProvider
				.getParser(
						Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Constraints_2009,
						view.getElement() != null ? view.getElement() : view,
						Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
								.getType(Modeluno.modeluno.diagram.edit.parts.ConstraintsCommentsEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
	 ...
	 * @generated
	 */
	private String getAttribute_Derived_2010Text(View view) {
		IParser parser = Modeluno.modeluno.diagram.providers.ModelunoParserProvider
				.getParser(
						Modeluno.modeluno.diagram.providers.ModelunoElementTypes.Attribute_Derived_2010,
						view.getElement() != null ? view.getElement() : view,
						Modeluno.modeluno.diagram.part.ModelunoVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getConstraints_Relation_4007Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getClass_Relation_4008Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getAttribute_Relation_4009Text(View view) {
		return ""; //$NON-NLS-1$
	}
