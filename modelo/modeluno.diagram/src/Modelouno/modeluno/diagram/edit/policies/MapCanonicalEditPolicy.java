...
public class MapCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(Modelouno.modeluno.ModelunoPackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<Modelouno.modeluno.diagram.part.ModelunoNodeDescriptor> childDescriptors = Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
				.getMap_1000SemanticChildren(viewObject);
		for (Modelouno.modeluno.diagram.part.ModelunoNodeDescriptor d : childDescriptors) {
	...
	protected void refreshSemantic() {
		...
		for (Iterator<Modelouno.modeluno.diagram.part.ModelunoNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			Modelouno.modeluno.diagram.part.ModelunoNodeDescriptor next = descriptorsIterator
					.next();
			String hint = Modelouno.modeluno.diagram.part.ModelunoVisualIDRegistry
		...
		for (Modelouno.modeluno.diagram.part.ModelunoNodeDescriptor next : childDescriptors) {
			String hint = Modelouno.modeluno.diagram.part.ModelunoVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = Modelouno.modeluno.diagram.part.ModelunoVisualIDRegistry
			...
			for (Iterator<Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor> collectAllLinks(
		...
		case Modelouno.modeluno.diagram.edit.parts.MapEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
		...
		case Modelouno.modeluno.diagram.edit.parts.CreateEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getCreate_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.ViewIndexEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getViewIndex_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getViewUpdateObject_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.AdminEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getAdmin_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case Modelouno.modeluno.diagram.edit.parts.UpdateObjectEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getUpdateObject_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.PageEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getPage_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.DeleteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getDelete_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case Modelouno.modeluno.diagram.edit.parts.ViewUpdateAttributeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getViewUpdateAttribute_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case Modelouno.modeluno.diagram.edit.parts.IndexEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getIndex_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.ViewEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getView_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getUpdateAttribute_2014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Attribute_Not_DerivedEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getAttribute_Not_Derived_2015ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.ViewInputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getViewInput_2016ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Attribute_DerivedEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getAttribute_Derived_2017ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Relation_AttributeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getRelation_Attribute_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Relation_ViewEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getRelation_View_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Relation_ClassEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getRelation_Class_4003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.Relation_ServiceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getRelation_Service_4004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Modelouno.modeluno.diagram.edit.parts.PresetationUnitEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(Modelouno.modeluno.diagram.part.ModelunoDiagramUpdater
						.getPresetationUnit_4005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (Modelouno.modeluno.diagram.part.ModelunoLinkDescriptor nextLinkDescriptor : linkDescriptors) {
