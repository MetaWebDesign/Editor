 ...
 * @generated
 */
public class ViewUpdateAttributeItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ViewUpdateAttributeItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Modelouno.modeluno.diagram.part.ModelunoVisualIDRegistry
					.getVisualID(incomingLink) == Modelouno.modeluno.diagram.edit.parts.Relation_ViewEditPart.VISUAL_ID) {
			...
			if (Modelouno.modeluno.diagram.part.ModelunoVisualIDRegistry
					.getVisualID(incomingLink) == Modelouno.modeluno.diagram.edit.parts.PresetationUnitEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
