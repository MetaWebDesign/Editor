 ...
 * @generated
 */
public class PresetationUnitName_fieldEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PresetationUnitName_fieldEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Modelouno.modeluno.diagram.edit.policies.ModelunoTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Modelouno.modeluno.diagram.providers.ModelunoParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					Modelouno.modeluno.diagram.edit.parts.ModelunoEditPartFactory
