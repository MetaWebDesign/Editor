 ...
 * @generated
 */
public class ModelunoModelingAssistantProviderOfUpdateAttributeEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modelouno.modeluno.diagram.edit.parts.UpdateAttributeEditPart) targetEditPart,
				relationshipType);
	}
