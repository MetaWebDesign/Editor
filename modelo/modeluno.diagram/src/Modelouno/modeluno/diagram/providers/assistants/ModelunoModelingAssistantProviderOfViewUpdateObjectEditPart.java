 ...
 * @generated
 */
public class ModelunoModelingAssistantProviderOfViewUpdateObjectEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modelouno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modelouno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modelouno.modeluno.diagram.edit.parts.ViewUpdateObjectEditPart) targetEditPart,
				relationshipType);
	}
