...
public class ModelunoModelingAssistantProviderOfViewUpdateAttributeEditPart
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modelouno.modeluno.diagram.edit.parts.ViewUpdateAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modelouno.modeluno.diagram.edit.parts.ViewUpdateAttributeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modelouno.modeluno.diagram.edit.parts.ViewUpdateAttributeEditPart) targetEditPart,
				relationshipType);
	}
