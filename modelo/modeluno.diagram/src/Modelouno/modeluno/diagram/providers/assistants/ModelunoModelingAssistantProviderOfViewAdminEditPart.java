 ...
 * @generated
 */
public class ModelunoModelingAssistantProviderOfViewAdminEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((Modelouno.modeluno.diagram.edit.parts.ViewAdminEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			Modelouno.modeluno.diagram.edit.parts.ViewAdminEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(Modelouno.modeluno.diagram.edit.parts.ViewAdminEditPart) targetEditPart,
				relationshipType);
	}
