 ...
 * @generated
 */
public class ModelunoDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ModelunoDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Modelouno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Modelouno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Modelouno.modeluno.diagram.navigator.ModelunoDomainNavigatorItem(
