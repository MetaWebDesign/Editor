...
/**
 * This is the item provider adapter for a {@link Modelouno.modeluno.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ViewsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_rol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_rol_feature", "_UI_Page_type"),
				 ModelunoPackage.Literals.PAGE__ROL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case ModelunoPackage.PAGE__ROL:
