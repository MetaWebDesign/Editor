...
/**
 * This is the item provider adapter for a {@link Modelouno.modeluno.Views} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelunoPackage.Literals.VIEWS__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Views_group_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Views_group_feature", "_UI_Views_type"),
				 ModelunoPackage.Literals.VIEWS__GROUP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
