...
/**
 * This is the item provider adapter for a {@link Modelouno.modeluno.Create} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateItemProvider extends ServiceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Create_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Create_name_feature", "_UI_Create_type"),
				 ModelunoPackage.Literals.CREATE__NAME,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelunoPackage.Literals.CREATE__HAS_VIEW_FORM_INPUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelunoPackage.Literals.CREATE__HAS_VIEW_FORM_INPUT,
