...
/**
 * This is the item provider adapter for a {@link Modelouno.modeluno.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider 
	...
	public String getText(Object object) {
		String label = ((Modelouno.modeluno.Class)object).getCname();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Modelouno.modeluno.Class.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelunoPackage.Literals.CLASS__HAS_RELATION,
				 ModelunoFactory.eINSTANCE.createRelation_Class()));

		newChildDescriptors.add
			(createChildParameter
				(ModelunoPackage.Literals.CLASS__HAS_ATRIBUTE_RELATION,
				 ModelunoFactory.eINSTANCE.createRelation_Attribute()));

		newChildDescriptors.add
			(createChildParameter
				(ModelunoPackage.Literals.CLASS__HAS_SERVICE_RELATION,
				 ModelunoFactory.eINSTANCE.createRelation_Service()));
	}
