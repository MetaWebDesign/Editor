...
/**
 * This is the item provider adapter for a {@link Modelouno.modeluno.Delete} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeleteItemProvider extends ServiceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Delete_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Delete_name_feature", "_UI_Delete_type"),
				 ModelunoPackage.Literals.DELETE__NAME,
				 false,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Delete.class)) {
			case ModelunoPackage.DELETE__NAME:
