...
public class ClassItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGoConstraintsRelationPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Go Constraints Relation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGoConstraintsRelationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_goConstraintsRelation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_goConstraintsRelation_feature", "_UI_Class_type"),
				 ModelunoPackage.Literals.CLASS__GO_CONSTRAINTS_RELATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelunoPackage.Literals.CLASS__HAS_CONSTRAINTS_RELATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelunoPackage.Literals.CLASS__HAS_CONSTRAINTS_RELATION,
				 ModelunoFactory.eINSTANCE.createConstraints_Relation()));
	}
