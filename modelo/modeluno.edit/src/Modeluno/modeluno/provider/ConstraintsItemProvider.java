...
/**
 * This is the item provider adapter for a {@link Modeluno.modeluno.Constraints} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraints_Comments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraints_Comments_feature", "_UI_Constraints_type"),
				 ModelunoPackage.Literals.CONSTRAINTS__COMMENTS,
				 true,
				 false,
				 false,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraints_Condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraints_Condition_feature", "_UI_Constraints_type"),
				 ModelunoPackage.Literals.CONSTRAINTS__CONDITION,
				 true,
				 false,
				 false,
	...
	protected void addErrorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraints_Error_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraints_Error_feature", "_UI_Constraints_type"),
				 ModelunoPackage.Literals.CONSTRAINTS__ERROR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFormulaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraints_Formula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraints_Formula_feature", "_UI_Constraints_type"),
				 ModelunoPackage.Literals.CONSTRAINTS__FORMULA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Constraints)object).getComments();
