...
public class ModelunoPackageImpl extends EPackageImpl implements ModelunoPackage {
	 ...
	 * @generated
	 */
	private EClass constraints_RelationEClass = null;
	 ...
	 * @generated
	 */
	public EReference getMap_Root_hasConstraints() {
	 ...
	 * @generated
	 */
	public EReference getClass_HasConstraintsRelation() {
	 ...
	 * @generated
	 */
	public EReference getClass_GoConstraintsRelation() {
	 ...
	 * @generated
	 */
	public EAttribute getConstraints_Comments() {
	 ...
	 * @generated
	 */
	public EAttribute getConstraints_Condition() {
	 ...
	 * @generated
	 */
	public EAttribute getConstraints_Error() {
	 ...
	 * @generated
	 */
	public EAttribute getConstraints_Formula() {
	 ...
	 * @generated
	 */
	public EClass getConstraints_Relation() {
		return constraints_RelationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getConstraints_Relation_GoConstraints() {
		return (EReference)constraints_RelationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getConstraints_Relation_HasConstraints() {
		return (EReference)constraints_RelationEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(mapEClass, MAP__ROOT_HAS_CONSTRAINTS);
		...
		createEReference(classEClass, CLASS__HAS_CONSTRAINTS_RELATION);
		createEReference(classEClass, CLASS__GO_CONSTRAINTS_RELATION);
		...
		createEAttribute(constraintsEClass, CONSTRAINTS__COMMENTS);
		createEAttribute(constraintsEClass, CONSTRAINTS__CONDITION);
		createEAttribute(constraintsEClass, CONSTRAINTS__ERROR);
		createEAttribute(constraintsEClass, CONSTRAINTS__FORMULA);

		constraints_RelationEClass = createEClass(CONSTRAINTS_RELATION);
		createEReference(constraints_RelationEClass, CONSTRAINTS_RELATION__GO_CONSTRAINTS);
		createEReference(constraints_RelationEClass, CONSTRAINTS_RELATION__HAS_CONSTRAINTS);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getMap_Root_hasConstraints(), this.getConstraints(), null, "root_hasConstraints", null, 0, -1, Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClass_HasConstraintsRelation(), this.getConstraints_Relation(), null, "hasConstraintsRelation", null, 0, 1, Modeluno.modeluno.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_GoConstraintsRelation(), this.getConstraints_Relation(), null, "goConstraintsRelation", null, 0, 1, Modeluno.modeluno.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getConstraints_Comments(), ecorePackage.getEString(), "Comments", null, 0, 1, Constraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraints_Condition(), ecorePackage.getEBoolean(), "Condition", null, 0, 1, Constraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraints_Error(), ecorePackage.getEString(), "Error", null, 0, 1, Constraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraints_Formula(), ecorePackage.getEString(), "Formula", null, 0, 1, Constraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constraints_RelationEClass, Constraints_Relation.class, "Constraints_Relation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConstraints_Relation_GoConstraints(), this.getConstraints(), null, "goConstraints", null, 0, 1, Constraints_Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConstraints_Relation_HasConstraints(), this.getConstraints(), null, "hasConstraints", null, 0, 1, Constraints_Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
