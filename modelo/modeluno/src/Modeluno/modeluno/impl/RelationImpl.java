 ...
 * <ul>
 *   <li>{@link Modeluno.modeluno.impl.RelationImpl#getR2 <em>R2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	 ...
	 * @ordered
	 */
	protected EList<Modeluno.modeluno.Class> r2;
	 ...
	 * @generated
	 */
	public EList<Modeluno.modeluno.Class> getR2() {
		if (r2 == null) {
			r2 = new EObjectResolvingEList<Modeluno.modeluno.Class>(Modeluno.modeluno.Class.class, this, ModelunoPackage.RELATION__R2);
		}
		return r2;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelunoPackage.RELATION__R2:
				getR2().clear();
				getR2().addAll((Collection<? extends Modeluno.modeluno.Class>)newValue);
				return;
		}
