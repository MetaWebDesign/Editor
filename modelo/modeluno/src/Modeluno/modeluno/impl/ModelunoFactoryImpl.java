...
public class ModelunoFactoryImpl extends EFactoryImpl implements ModelunoFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelunoPackage.CONSTRAINTS: return createConstraints();
			case ModelunoPackage.CONSTRAINTS_RELATION: return createConstraints_Relation();
			default:
	 ...
	 * @generated
	 */
	public Constraints_Relation createConstraints_Relation() {
		Constraints_RelationImpl constraints_Relation = new Constraints_RelationImpl();
		return constraints_Relation;
	}
