 ...
 *   <li>{@link Modeluno.modeluno.Map#getRoot_hasConstraints <em>Root has Constraints</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Map extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Root has Constraints</b></em>' containment reference list.
	 * The list contents are of type {@link Modeluno.modeluno.Constraints}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Root has Constraints</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Root has Constraints</em>' containment reference list.
	 * @see Modeluno.modeluno.ModelunoPackage#getMap_Root_hasConstraints()
	 * @model containment="true"
	 * @generated
	 */
	EList<Constraints> getRoot_hasConstraints();
