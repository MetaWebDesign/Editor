 ...
 *   <li>{@link Modeluno.modeluno.Class#getHasConstraintsRelation <em>Has Constraints Relation</em>}</li>
 *   <li>{@link Modeluno.modeluno.Class#getGoConstraintsRelation <em>Go Constraints Relation</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Class extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Has Constraints Relation</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Has Constraints Relation</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Has Constraints Relation</em>' containment reference.
	 * @see #setHasConstraintsRelation(Constraints_Relation)
	 * @see Modeluno.modeluno.ModelunoPackage#getClass_HasConstraintsRelation()
	 * @model containment="true"
	 * @generated
	 */
	Constraints_Relation getHasConstraintsRelation();

	/**
	 * Sets the value of the '{@link Modeluno.modeluno.Class#getHasConstraintsRelation <em>Has Constraints Relation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Has Constraints Relation</em>' containment reference.
	 * @see #getHasConstraintsRelation()
	 * @generated
	 */
	void setHasConstraintsRelation(Constraints_Relation value);

	/**
	 * Returns the value of the '<em><b>Go Constraints Relation</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Go Constraints Relation</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Go Constraints Relation</em>' reference.
	 * @see #setGoConstraintsRelation(Constraints_Relation)
	 * @see Modeluno.modeluno.ModelunoPackage#getClass_GoConstraintsRelation()
	 * @model
	 * @generated
	 */
	Constraints_Relation getGoConstraintsRelation();

	/**
	 * Sets the value of the '{@link Modeluno.modeluno.Class#getGoConstraintsRelation <em>Go Constraints Relation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Go Constraints Relation</em>' reference.
	 * @see #getGoConstraintsRelation()
	 * @generated
	 */
	void setGoConstraintsRelation(Constraints_Relation value);
