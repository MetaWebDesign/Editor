...
public class ModelunoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelunoPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelunoPackage.ATRIBUTTE: {
				Atributte atributte = (Atributte)theEObject;
				T result = caseAtributte(atributte);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelunoPackage.RATTRIBUTE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Atributte</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Atributte</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAtributte(Atributte object) {
		return null;
	}
