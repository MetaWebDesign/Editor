...
public class ModelunoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelunoPackage.CLASS_RELATION: {
				Class_Relation class_Relation = (Class_Relation)theEObject;
				T result = caseClass_Relation(class_Relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelunoPackage.ATTRIBUTE_RELATION: {
				Attribute_Relation attribute_Relation = (Attribute_Relation)theEObject;
				T result = caseAttribute_Relation(attribute_Relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelunoPackage.CONSTRAINTS: {
				Constraints constraints = (Constraints)theEObject;
				T result = caseConstraints(constraints);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelunoPackage.CONSTRAINTS_RELATION: {
				Constraints_Relation constraints_Relation = (Constraints_Relation)theEObject;
				T result = caseConstraints_Relation(constraints_Relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseClass_Relation(Class_Relation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attribute Relation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Attribute Relation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAttribute_Relation(Attribute_Relation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Constraints Relation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Constraints Relation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConstraints_Relation(Constraints_Relation object) {
		return null;
	}
