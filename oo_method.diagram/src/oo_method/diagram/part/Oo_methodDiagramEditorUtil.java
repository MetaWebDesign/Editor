 ...
 * @generated
 */
public class Oo_methodDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page.openEditor(new URIEditorInput(diagram.getURI()),
				oo_method.diagram.part.Oo_methodDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							oo_method.diagram.part.Messages.Oo_methodDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									oo_method.diagram.part.Messages.Oo_methodDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = oo_method.diagram.part.Oo_methodDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						oo_method.diagram.part.Messages.Oo_methodDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				oo_method.diagram.part.Messages.Oo_methodDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				oo_method.StructuralModel model = createInitialModel();
	 ...
	 * @generated
	 */
	private static oo_method.StructuralModel createInitialModel() {
		return oo_method.Oo_methodFactory.eINSTANCE.createStructuralModel();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(oo_method.StructuralModel model,
			Resource resource) {
